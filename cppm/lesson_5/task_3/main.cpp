...
public:
    Quadrangle(double a, double b, double c, double d, double angle1, double angle2, double angle3, double angle4) : Figure("Quadrangle", 4), sideA(a), sideB(b), sideC(c), sideD(d), angleA(angle1), angleB(angle2),
